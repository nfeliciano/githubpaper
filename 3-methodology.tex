...
The main use of GitHub was for material dissemination: the instructor hosted a public repository which all students could access to find the work they had to do for any given week. The instructor updated this repository weekly, adding lab assignments, links to readings, and the student homework for the week. All of the content was organized into a calendar-style table made with Markdown and was posted on the home page of the course repository. If students wanted to make changes to the content, they could `fork' the repository and use a Pull Request to alert the instructors, though this possibility was not advertised during the courses.\todo[inline]{CP: is the fact that it wasn't advertise actually significant? if not, I'd remove that bit. also, did the students even make use of it? I thought no one did, but I can't remember anymore.}
...
In addition to GitHub, the course instructor opted to use a version of the Moodle LMS\footnote{\url{https://moodle.org/}}. Moodle generally allows instructors to make their course content available for students to access and interact with, enable communication between the instructors and students through forums, post quizzes, create wikis for a class to edit, and track student progress and performance.\todo[inline]{CP: should you talk a little more about how Moodle allows one to control privacy/access better?} For the courses in our study, Moodle was used for work that the course instructor felt should not be publicly available, including student grades and student responses to the course readings.
...
%TODO: add sentence about interviewing the course instructor, and add it to future work
