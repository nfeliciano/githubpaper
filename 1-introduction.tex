...
This study aims to explore the use of a tool such as GitHub and its effectiveness in the educational context. These research questions are exploratory in nature:\todo[inline]{too repetitive}
\begin{enumerate}
...
In this case study, we conducted interviews with the students of two software engineering courses. Our findings indicate that students enjoyed the benefits of GitHub's transparency features and open workflow. However, students expressed concerns that GitHub is not inherently an educational tool and is therefore missing key features that prevent it from being an ideal tool for this context.\todo[inline]{this paragraph should be in an abstract and not the intro}
